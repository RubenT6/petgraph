...
#[bench]
fn kosaraju_scc_bench(bench: &mut Bencher) {
...
#[bench]
fn kosaraju_scc_bench_self_loops(bench: &mut Bencher) {
    static NODE_COUNT: usize = 100_000;
    let mut g: Graph<usize, ()> = Graph::new();
    let nodes: Vec<NodeIndex<_>> = (0..NODE_COUNT).map(|i| g.add_node(i)).collect();
    for i in 0..NODE_COUNT - 1 {
...
#[bench]
fn kosaraju_scc_bench_two_way_chain(bench: &mut Bencher) {
    static NODE_COUNT: usize = 100_000;
    let mut g: Graph<usize, ()> = Graph::new();
    let nodes: Vec<NodeIndex<_>> = (0..NODE_COUNT).map(|i| g.add_node(i)).collect();
    for i in 0..NODE_COUNT - 1 {
...
#[bench]
fn kosaraju_scc_bench_big_loop(bench: &mut Bencher) {
    static NODE_COUNT: usize = 100_000;
    let mut g: Graph<usize, ()> = Graph::new();
    let nodes: Vec<NodeIndex<_>> = (0..NODE_COUNT).map(|i| g.add_node(i)).collect();
    for i in 0..NODE_COUNT - 1 {
...
#[bench]
fn kosaraju_scc_bench_many_edges(bench: &mut Bencher) {
...
#[bench]
fn kosaraju_scc_bench_chain_sccs(bench: &mut Bencher) {
...
#[bench]
fn kosaraju_scc_bench_disjoint_sccs(bench: &mut Bencher) {
    static CLIQUE_SIZE: usize = 100;
    static CLIQUE_COUNT: usize = 100;
    let mut g: Graph<usize, ()> = Graph::new();
    let nodes: Vec<NodeIndex<_>> = (0..(CLIQUE_SIZE * CLIQUE_COUNT))
...
#[bench]
fn kosaraju_scc_bench_random(bench: &mut Bencher) {
